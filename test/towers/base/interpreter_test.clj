(ns towers.base.interpreter-test
  (:refer-clojure :exclude [reify eval])
  (:require [clojure.test :refer :all]
            [meliae.patterns :refer [print-pattern]]
            [towers.base.ast :refer :all]
            [towers.base.interpreter :refer :all]
            [clojure.spec.test.alpha :as stest]))

;; (stest/instrument (stest/enumerate-namespace ['meliae.patterns 'towers.base.ast 'towers.base.interpreter]))
